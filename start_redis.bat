...
IF DEFINED MEMURAI_EXE (
    ...
    SET /A WAIT+=1
    IF !WAIT! LSS 10 GOTO :wait_pong

    ECHO [ERROR] Memurai no responde tras 10 segundos.
    ECHO         Verifica la instalacion: !MEMURAI_EXE!
    PAUSE
    GOTO :END
)
...
IF EXIST "C:\Program Files\Redis\redis-server.exe" (
    ...
    start "BSP - Redis" "C:\Program Files\Redis\redis-server.exe"
