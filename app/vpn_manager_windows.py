...
class NordVPNManagerWindows:
    ...
    def _dismiss_nordvpn_popup(self):
        ...
        try:
            ...
            # Non-zero return code or stderr output indicates PowerShell failure.
            if result.returncode != 0:
                logger.debug(
            ...
            logger.debug(f"[BUG-V6-012] _dismiss_nordvpn_popup failed (non-critical): {e}")
    ...
    def get_current_ip(self) -> str:
        ...
        for service in services:
            try:
                resp = requests.get(service, timeout=_ip_timeout)
