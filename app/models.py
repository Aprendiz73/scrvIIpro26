...
from sqlalchemy import (
    ...
    JSON, Float, ForeignKey, Index, func  # [NEW-18] func needed for server_default=func.now()
)
...
class URLLanguageStatus(Base):
    ...
    __table_args__ = (
        ...
        # [NEW-05] Composite index for WHERE url_id=:id AND status IN ('pending','failed')
