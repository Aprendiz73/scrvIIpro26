...
class URLQueue(Base):
    ...
    __table_args__ = (
        ...
        # priority DESC, created_at ASC = orden exacto del ORDER BY → index-only scan posible.
        #
        # REEMPLAZA: ix_urlqueue_status_priority, ix_urlqueue_dispatch (índices completos).
        # ACCIÓN REQUERIDA: Crear con CONCURRENTLY en producción para evitar lock exclusivo:
        ...
        # Este índice se gestiona manualmente vía SQL/Alembic migration.
